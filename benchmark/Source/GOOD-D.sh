...
python benchmark/mymain.py -exp_type ad -DS COLLAB -batch_size 64 -batch_size_test 64 -num_epoch 100 -num_cluster 2 -alpha 0.8 --model GOOD-D

python benchmark/mymain.py  -exp_type ad -DS COX2 -num_epoch 150 -num_cluster 3 -alpha 0.4 --model GOOD-D
...
python benchmark/mymain.py -exp_type ad -DS DHFR -num_epoch 20 -num_cluster 2 -alpha 0 --model GOOD-D
...
python benchmark/mymain.py  -exp_type ad -DS PROTEINS_full -num_epoch 20 -num_cluster 2 -alpha 0.2 --model GOOD-D
...
python benchmark/mymain.py  -exp_type ad -DS Tox21_PPAR-gamma -num_epoch 200 -num_cluster 10 -alpha 0.8 --model GOOD-D

python benchmark/mymain.py  -exp_type ad -DS Tox21_p53 -num_epoch 150 -num_cluster 5 -alpha 0.2 --model GOOD-D
...
python benchmark/mymain.py -exp_type oodd -DS_pair ENZYMES+PROTEINS -num_epoch 150 -num_cluster 15 -alpha 0.2 --model GOOD-D

python benchmark/mymain.py -exp_type oodd -DS_pair IMDB-MULTI+IMDB-BINARY -num_epoch 20 -num_cluster 5 -alpha 0.8 --model GOOD-D
...
python benchmark/mymain.py -exp_type ood -DS DrugOOD -num_epoch 200 -num_cluster 10 -alpha 0.2 --model GOOD-D
