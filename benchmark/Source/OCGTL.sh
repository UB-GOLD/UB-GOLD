...
python benchmark/mymain.py -exp_type ad -DS NCI1              -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.001 -hidden_dim 128 -num_layer 4 -model OCGTL OCGTL
...
python benchmark/mymain.py -exp_type ad -DS Tox21_HSE           -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.0001 -hidden_dim 64 -num_layer 4 -model OCGTL OCGTL


# double dataset

python benchmark/mymain.py -exp_type oodd -DS_pair AIDS+DHFR    -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.001 -hidden_dim 128 -num_layer 3 -model OCGTL OCGTL
...
python benchmark/mymain.py -exp_type oodd -DS_pair ogbg-molbbbp+ogbg-molbace     -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.0001 -hidden_dim 32 -num_layer 3 -model OCGTL OCGTL

python benchmark/mymain.py -exp_type oodd -DS_pair ogbg-molfreesolv+ogbg-moltoxcast    -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.001 -hidden_dim 128 -num_layer 4 -model OCGTL OCGTL

python benchmark/mymain.py -exp_type oodd -DS_pair ogbg-molclintox+ogbg-mollipo    -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.001 -hidden_dim 128 -num_layer 4 -model OCGTL OCGTL
...
python benchmark/mymain.py -exp_type oodd -DS_pair ogbg-moltox21+ogbg-molsider    -batch_size  128 -batch_size_test 9999  -num_epoch 500 -lr 0.0001 -hidden_dim 64 -num_layer 3 -model OCGTL OCGTL
